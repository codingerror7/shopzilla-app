...
const Page2 = () => {
  ...
  return (
    ...
    <div className='min-h-screen md:min-h-[310vh] lg:min-h-[300vh] w-[100%] bg-gradient-to-r from-violet-500 to-blue-300 overflow-hidden'>
        <div className='w-[70vw] md:w-[50vw] lg:w-[40vw] lg:h-[10vh] mx-auto flex items-center lg:justify-around justify-between p-[1%] mt-0 md:mt-0 lg:mt-10 font-[gilroy] font-semibold'>
        <div className='lg:h-[70%] lg:w-[31%] rounded-[30px] text-[12px] lg:text-[14px] text-center text-white bg-indigo-950 px-4 py-2 lg:p-[0.5%]'>Cash on Delivery</div>
        <div className='lg:h-[70%] lg:w-[31%] rounded-[30px] px-4 py-2 text-[12px] lg:text-[14px] text-center text-white bg-indigo-950 lg:p-[0.5%]'>Easy 7 day returns</div>
        <div className='lg:h-[70%] lg:w-[31%] rounded-[30px] px-4 py-2 text-[12px] lg:text-[14px] text-center text-white bg-indigo-950 lg:p-[0.5%]'>Lowest prices %</div>
    </div>
        <div className='grid grid-cols-3 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 w-[95vw] lg:mt-[2%] mx-auto mt-[4%] gap-4 place-items-center'>
